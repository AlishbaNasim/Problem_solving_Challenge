...
function areAnagrams(str1: string, str2: string): boolean {
    ...
    let charCodeAt: number[] = new Array(26).fill(0)
...
function reverseWords(sentences: string): string {
    // *Identify Word Boundaries:*
    let word: string[] = sentences.split(' ')
    ...
    let resentences: string = reverseWords.join(' ')
    //return result
    return resentences

}
const reverse: string = 'Alishba Naseem'
